    ...
    ?>
		<div class="col-md-11">
			<div class="row">
						...
						<div class="post-author-wrap ">
							<div class="media">
                                <a class="pull-left" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>">
            						<img class="media-object" alt="<?php esc_attr( the_author_meta( 'display_name' )); ?>" src="<?php echo unpress_get_avatar_url(get_avatar( $post->ID, 100 )); ?>">
            					</a>
                ...
                <?php if(get_field( 'interview_posts_sidebar' ) == "interview_post_sidebar_on"):?>
                <div class="sidebar col-md-3 col-sm-12 pull-right">
