...
class sidebar_generator {
	...
	function admin_menu(){
		...
		add_object_page( THEMENAME, 'Unlimited Sidebars', 'manage_options', 'multiple_sidebars', array('sidebar_generator','admin_page'));
	...
	*/
	...
	<div id="sbg-sortables" class="unpress_unlimited_sidebars meta-box-sortables">
		<div id="sbg_box" class="postbox " >
			<div class="handlediv" title="Click to toggle"><br /></div><h3 class='hndle'><span>Choose Sidebar</span></h3>
			<div class="inside">
				<div class="sbg_container">
					<input name="sbg_edit" type="hidden" value="sbg_edit" />
					
					<p>Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Unlimited Sidebars.
					</p>
					<ul>
					<?php 
