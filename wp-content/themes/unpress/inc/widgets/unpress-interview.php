			...
			<div class="widget-content">
                ...
                <div class="latest-interviews-carousel">
                    ...
                    <div class="latest-interviews-carousel-arrows">
                        <a href="#" class="latest-interviews-carousel-prev"><i class="fa fa-angle-left"></i></a>
                        <a href="#" class="latest-interviews-carousel-next"><i class="fa fa-angle-right"></i></a>
                    </div>
                
                    <div class="widget-latest-interviews-carousel">
