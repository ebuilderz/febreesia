			...
			<div class="widget-content">
                ...
                <div class="latest-post-carousel">
                        ...
                        <div class="latest-post-gallery-carousel-arrows">
                            <a href="#" class="featured-post-gallery-carousel-prev"><i class="fa fa-angle-left"></i></a>
                            <a href="#" class="featured-post-gallery-carousel-next"><i class="fa fa-angle-right"></i></a>
                        </div>
                    
                        <div class="widget-featured-post-carousel">
