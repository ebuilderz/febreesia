...
} elseif($ft_option['standard_body'] != '0') {
...
} elseif($ft_option['standard_font_titles'] != '0') {
...
} elseif($ft_option['standard_main_nav'] != '0') {
...
} elseif($ft_option['standard_secondary_nav'] != '0') {
...
} elseif($ft_option['standard_blackbox'] != '0') {
