		...
		<div class="col-md-10 col-md-offset-1">
			<div class="featured-video-wrap text-center">				
				<div class="featured-video-title">
					...
					<h2><a href="<?php echo $video->guid; ?>"><?php echo $video->post_title; ?></a></h2>
				...
				<div class="video-tools tools">
                    ...
                    <div id="share-page" style="display: none;">
                        <ul class="text-center list-unstyled">
                            <li><a href="http://www.facebook.com/sharer.php?u=<?php echo $video->guid; ?>&amp;t=<?php echo $video->post_title; ?>" target="blank"><?php _e( 'Facebook', 'favethemes' ); ?></a></li>
                            <li><a href="https://twitter.com/intent/tweet?original_referer=<?php echo $video->guid; ?>&amp;text=<?php echo $video->post_title; ?>&tw_p=tweetbutton&url=<?php echo $video->guid; ?>&via=<?php bloginfo( 'name' ); ?>" target="_blank"><?php _e( 'Twitter', 'favethemes' ); ?></a></li>
                            <li><a href="https://plusone.google.com/_/+1/confirm?hl=en-US&amp;url=<?php echo $video->guid; ?>" target="_blank"><?php _e( 'Google +', 'favethemes' ); ?></a></li>
                            <li>
                                <?php $pinimage = wp_get_attachment_image_src( get_post_thumbnail_id( $video->ID ), 'large' ); ?>
                                <a href="//pinterest.com/pin/create/button/?url=<?php echo $video->guid; ?>&amp;media=<?php echo $pinimage[0]; ?>&amp;description=<?php echo $video->post_title; ?>" target="_blank"><?php _e( 'Pinterest', 'favethemes' ); ?></a>
                            </li>
                        </ul>
                    </div>
                    <!-- End Post Share -->	
					...
					<a href="<?php echo $video->guid; ?>" class="action-tool tool-btn">
